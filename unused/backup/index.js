...
const devices = [
  { name: "IOT NODE 001", ip: "172.19.88.17", status: "UNKNOWN", severity: "MEDIUM" },
  { name: "Printer M#5", ip: "172.19.88.21", status: "UNKNOWN", severity: "LOW" },
  { name: "DCS MIXING MATERIAL F4", ip: "172.19.88.30", status: "UNKNOWN", severity: "HIGH" },
  { name: "DCS PLAYMAKER F4", ip: "172.19.88.16", status: "UNKNOWN", severity: "CRITICAL" },
  { name: "DCS QI F4", ip: "172.19.88.19", status: "UNKNOWN", severity: "CRITICAL" },
  { name: "DCS REPAIR IN LINE F4", ip: "172.19.88.20", status: "UNKNOWN", severity: "HIGH" },
  { name: "DCS POLES F4", ip: "172.19.88.29", status: "UNKNOWN", severity: "HIGH" },
  { name: "DCS TASK FORCE F4", ip: "172.19.88.24", status: "UNKNOWN", severity: "CRITICAL" },
];
